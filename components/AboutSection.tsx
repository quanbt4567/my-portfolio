  ...
  return (
    <section id="about" className="px-6 max-w-7xl mx-auto w-full pt-32 scroll-mt-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:auto-rows-[250px]">
        ...
        {/* Image Card */}
        <div className="md:col-span-1 md:row-span-2 rounded-[2rem] overflow-hidden border border-zinc-200 dark:border-zinc-800 relative group min-h-[300px] md:min-h-0">
          <ImageParallax 
        ...
        {/* Location Card */}
        <div className="md:col-span-1 bg-zinc-50 dark:bg-zinc-900 rounded-[2rem] p-6 border border-zinc-200 dark:border-zinc-800 flex flex-col justify-between relative overflow-hidden group min-h-[200px] md:min-h-0">
        ...
        {/* Availability Card */}
        <div className="md:col-span-1 bg-zinc-50 dark:bg-zinc-900 rounded-[2rem] p-6 border border-zinc-200 dark:border-zinc-800 flex flex-col justify-center items-center relative overflow-hidden group min-h-[200px] md:min-h-0">
