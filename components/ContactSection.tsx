...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="px-6 max-w-3xl mx-auto w-full pt-24 pb-24 text-center scroll-mt-16">
      <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-white mb-6">
        {t("title")}
      </h2>
      <p className="text-lg text-zinc-400 mb-12 font-medium">
        {t("description")}
      </p>
      ...
      <div className="flex items-center justify-center gap-6 mt-16 pt-8 border-t border-zinc-800">
        <Magnetic>
